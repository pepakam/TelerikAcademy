...
//between 1 and 3, the program multiplies it by 10; if it is between 4 and 6, multiplies it by 100; if it is between 7 and 9, multiplies it
...
class BonusScores
{
    static void Main()
    {
        Console.Write("Please, type a digit: ");
        ...
        switch (digit)
        {
            ...
            case 9:
                ...
                break;
            default:
                Console.WriteLine("This is program error!");
                break;
        }
